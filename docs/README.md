...
| Doc | Read it when |
|---|---|
| [sync.md](sync.md) | Changing scheduled jobs, startup behaviour, or how work moves through the system |
| [watchlist.md](watchlist.md) | Changing watchlist fetching, matching, `addedAt` handling, or collection publish triggers |
| [image-caching.md](image-caching.md) | Changing poster/avatar fetch, storage, refresh, or serving behaviour |
| [seerr.md](seerr.md) | Changing Seerr connectivity, user mapping, request logic, or the service account lifecycle |
